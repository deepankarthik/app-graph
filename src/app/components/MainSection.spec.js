...
var store = store_1.StoreModule.provideStore(store_1.combineReducers({ todos: todos_1.todos, visibility: todos_1.visibility }), {});
describe('MainSection component', function () {
    describe('mocked', function () {
        ...
        it('should render container', function () {
            var fixture = testing_1.TestBed.createComponent(MainSection_1.MainSectionComponent);
    ...
    describe('footer', function () {
        ...
        it('should render', function () {
            ...
            expect(FooterCmp.filter.type).toBe(TodoFilters_1.SHOW_ALL);
        });
        it('onShow should set the filter', function () {
            var fixture = testing_1.TestBed.createComponent(MainSection_1.MainSectionComponent);
            fixture.detectChanges();
            var FooterCmp = fixture.debugElement.query(platform_browser_1.By.css('fountain-footer')).componentInstance;
            FooterCmp.onShow.emit(TodoFilters_1.SHOW_COMPLETED);
            fixture.detectChanges();
            expect(FooterCmp.filter.type).toBe(TodoFilters_1.SHOW_COMPLETED);
        });
