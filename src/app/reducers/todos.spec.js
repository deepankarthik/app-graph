...
describe('Reducers', function () {
    describe('todo reducer', function () {
        it('should handle initial state', function () {
            expect(todos_1.todos(undefined, {})).toEqual([
                {
                    text: 'Use ngrx/store',
                    completed: false,
                    id: 0
    ...
    describe('visibility reducer', function () {
        it('should handle initial state', function () {
            expect(todos_1.visibility(undefined, { type: '', filter: undefined }).type).toEqual(filters.SHOW_ALL);
            expect(todos_1.visibility(undefined, { type: '', filter: null }).filter(null)).toEqual(true);
        });
        it('should handle SHOW_COMPLETED', function () {
            var showCompleted = todos_1.visibility({ type: filters.SHOW_ALL, filter: function () { return true; } }, { type: filters.SHOW_COMPLETED });
        ...
        it('should handle SHOW_ACTIVE', function () {
            var showActive = todos_1.visibility({ type: filters.SHOW_ALL, filter: function () { return true; } }, { type: filters.SHOW_ACTIVE });
        ...
        it('should handle SHOW_ALL', function () {
            var showAll = todos_1.visibility(undefined, { type: filters.SHOW_ALL });
